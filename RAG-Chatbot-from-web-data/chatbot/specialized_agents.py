...
class ItineraryPlannerAgent(BaseSpecializedAgent):
    ...
    def __init__(self):
        super().__init__(
            ...
            domain_focus="Multi-day trip itineraries with clear separation of logistics (travel times, transit modes) and activities, realistic overland travel calculations across Ethiopian terrain, and route planning."
        )
